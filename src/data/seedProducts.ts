...
export const products: Product[] = [
  ...
  {
    id: '13',
    slug: 'pulseiras-berloques-charm',
    name: 'Pulseiras de Berloques Charm',
    description:
      'Pulseiras rígidas em prata 925 para berloques — ideal para montar seu look com charms. Peças versáteis para uso diário ou sobreposição.',
    price: 189,
    images: ['/products/pulseiras-berloques-charm.png'],
    category: 'berloques-pulseiras',
    badge: 'novidade',
    rating: 5,
    reviewCount: 12,
    inStock: true,
  ...
  {
    id: '14',
    slug: 'conjunto-halo-cravejado',
    name: 'Conjunto Halo Cravejado',
    description:
      'Conjunto em prata 925 com colar, brincos e anel no mesmo desenho circular cravejado. Harmonia perfeita para presentear ou usar juntas.',
    price: 459,
    images: ['/products/conjunto-halo-cravejado.png'],
    category: 'conjuntos',
    badge: 'novidade',
    rating: 5,
    reviewCount: 8,
  ...
  {
    id: '15',
    slug: 'colar-espirito-santo-cravejado',
    name: 'Colar Espírito Santo Cravejado',
    description:
      'Colar em prata 925 com pingente do Divino Espírito Santo em círculo cravejado. Peça delicada e cheia de significado.',
    price: 219,
    images: ['/products/colar-espirito-santo-cravejado.png'],
    category: 'colares',
    badge: 'novidade',
    rating: 4.9,
    reviewCount: 15,
